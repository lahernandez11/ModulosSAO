...
class EstimacionSubcontratoFormatoPDF_NAP3 extends FormatoPDF
{
	...
	protected $titulo = 'CONSORCIO CARGI-PROPEN S.A. DE C.V.';
        protected $subtitulo = 'Cuerpo de Estimación';
	...
	protected $firma_control_estimaciones_descripcion_label = 'RESIDENTE DE FRENTE';
    ...
    protected $firma_planeacion_descripcion_label = 'CONTROL DE PROYECTOS';
	...
	private function writeDatosGeneralesEstimacion()
    {
		...
		$this->SetFont('Arial', '', 7);
                ...
                $this->image('../../../img/app/cargipropen_reducido_acarreos.jpg', 10, 10, 39, 30);
		...
		// $this->SetX($this->GetX() + 20);
                $xPosDatai = $this->GetX();
                $this->SetX(50);
		$this->Cell(150, 10, $this->titulo, 0, 1, "C",0);
		$this->resetFontSize();
		$this->resetTextColor();
    ...
    public function Footer()
    {
        ...
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(29, 3, $this->firma_superintendencia_titulo_label, 1, 0, "C", true);
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(29, 3, $this->firma_calidad_titulo_label, 1, 0, "C", true);
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(29, 3, $this->firma_planeacion_titulo_label, 1, 0, "C", true);
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(29, 3, $this->firma_subcontratos_titulo_label, 1, 0, "C", true);
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(29, 3, $this->firma_director_proyecto_titulo_label, 1, 0, "C", true);
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(29, 3, $this->firma_administrador_titulo_label, 1, 0, "C", true);
        ...
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(29, 3, "Ing. José Luis Gaona Aburto", "LRB", 0, "C");
        $this->Cell(5, 3, "", 0, 0);
	...
	$this->Ln();
        ...
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(29, 3, $this->firma_superintendencia_descripcion_label, 1, 0, "C", true);
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(29, 3, $this->firma_calidad_descripcion_label, 1, 0, "C", true);
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(29, 3, $this->firma_planeacion_descripcion_label, 1, 0, "C", true);
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(29, 3, $this->firma_subcontratos_descripcion_label, 1, 0, "C", true);
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(29, 3, $this->firma_director_proyecto_descripcion_label, 1, 0, "C", true);
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(29, 3, $this->firma_administrador_descripcion_label, 1, 0, "C", true);
