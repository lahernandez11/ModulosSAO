...
class EstimacionSubcontratoFormatoPDF_NAP3 extends FormatoPDF
{
    ...
    public function Footer()
    {
        ...
        $this->Cell(25, 3, "", 1, 0, "C");
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(25, 3, "Ing. Luis Sánchez Padilla", "LRB", 0, "C");
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(25, 3, "Ing. José Luis Gaona Aburto", "LRB", 0, "C");
        $this->Cell(5, 3, "", 0, 0);
        //$this->Cell(25, 8, "", 1, 0, "C");
        //$this->Cell(5, 8, "", 0, 0);
        $this->Cell(25, 3, "Ing. Arturo Mejia Bernal", "LRB", 0, "C");
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(25, 3, "Ing. Victor Manuel Orozco Muñoz", "LRB", 0, "C");
        $this->Cell(5, 3, "", 0, 0);
        $this->Cell(25, 3, "Lic. Adlay Kepler Barrios Figueroa", "LRB", 0, "C");
