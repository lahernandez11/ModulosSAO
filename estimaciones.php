...
<head>
	...
	<link href="css/estimaciones.css" type="text/css" rel="stylesheet" />
		...
		<div id="app-content">
			<div id="app-module">
				<header id="app-module-header">
					<h4>-> ESTIMACIONES DE SUBCONTRATOS</h4>
				</header>
				<div class="module-toolbar">
					...
					<a id="nuevo" class="toolbar-button new"><span class="icon"></span><span class="label">Nuevo</span></a>
					<a id="eliminar" class="toolbar-button delete"><span class="icon"></span><span class="label">Eliminar</span></a>
					<a id="guardar" class="toolbar-button save"><span class="icon"></span><span class="label">Guardar</span></a>
				</div>
